...
class MarkdownGenerator
  IMAGE_BASE_URL = 'https://raw.githubusercontent.com/DaCuteRaccoon/Connect4/master/images'
  ISSUE_BASE_URL = 'https://github.com/DaCuteRaccoon/Connect4/issues/new'
  ...
  def readme(metadata:, recent_moves:)
    ...
    markdown = <<~HTML
        Test. [DaCuteRaccoon](https://github.com/DaCuteRaccoon). This is a test.
    ...
    markdown.concat <<~HTML
        ...
        Interested in how everything works? [Click here](https://github.com/DaCuteRaccoon/Connect4/tree/master/connect4) to read up on what's happening behind the scenes.
